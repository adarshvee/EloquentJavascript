...
of cases raises an exception of type MultiplicatorUnitFailure. Write a function that wraps this clunky function and just keeps
  ...
  do {
    try {
      ...
      if (error instanceof MultiplicatorUnitFailure) {
        console.log("Retrying because of randomness failure");
      }
      else {
...
//Retrying because of randomness failure (9 times)
//64
